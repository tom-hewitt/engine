...
type ReferenceType = "Boolean Reference" | "String Reference" | "Integer Reference" | "Float Reference" | "3D Vector Reference";

type Literal = LiteralBoolean | LiteralString | LiteralInteger | LiteralFloat | Literal3DVector;
