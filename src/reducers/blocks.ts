...
export type ReturnableBuiltInFunctionBlock =
  | NormaliseBuiltInFunctionBlock
  | ModulusBuiltInFunctionBlock;
...
export interface NormaliseBuiltInFunctionBlock
  extends BaseBuiltInFunctionBlock {
  name: "Normalise";
  arguments: {
    byId: {
      a: ExpressionId;
