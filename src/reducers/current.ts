...
export const insertExpressionBlock = createAsyncThunk(
    ...
    ({ expressionId, expressionBlockId }: { expressionId: ExpressionId, expressionBlockId: ExpressionBlockId }, { getState }) => {
...
export const algorithms = {
    insertExpressionBlock: (state: CurrentState, expressionId: ExpressionId, expressionBlockId: ExpressionBlockId, parent: ExpressionId) => {
    ...
    undoInsertExpressionBlock: (state: CurrentState, expressionId: ExpressionId, expressionBlockId: ExpressionBlockId, parent: ExpressionId, replacedExpression: Expression) => {
...
export const current = createReducer(initialCurrentState, (builder) => {
    builder
        .addCase(insertExpressionBlock.fulfilled, (state, { payload: { undo, expressionId, expressionBlockId, replacedExpression, parent }}) => {
            if (undo) {
                algorithms.undoInsertExpressionBlock(state, expressionId, expressionBlockId, parent, replacedExpression);
            } else {
                algorithms.insertExpressionBlock(state, expressionId, expressionBlockId, parent);
            }
        })
